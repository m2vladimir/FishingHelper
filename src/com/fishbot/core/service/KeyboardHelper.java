...
/**
 * Helper class to work with virtual keyboard.
 */
public class KeyboardHelper {

    private Robot robot;

    public KeyboardHelper(Robot robot) {
     ...
     *
     * @param keyCodes key codes to type
     */
    ...
    /**
     * Send a given character to system using virtual keyboard.
     *
     * @param character char to type
     */
